...
class JobPostForm(FlaskForm):
    ...
    job_desc_image = FileField('Upload Job Description Flyre', validators=[FileAllowed(['jpg', 'png'])])
    job_file = FileField('Upload Job Description File', validators=[FileAllowed(['pdf', 'docx']), FileRequired()])
